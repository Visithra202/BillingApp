        ...
        <div className='bg-white m-4  border rounded-5 shadow'>
            ...
            <form onSubmit={handleSubmit} className='p-3 px-5' autoComplete='off'>
                <div className='d-flex flex-column'>
                    ...
                    <input type='text' className='form-control p-2' name='customer_name' value={formData?.customer_name||''}
                        onChange={handleChange}  required></input>
                </div>
                <div className='d-flex flex-column mt-3'>
                    <label className='form-label'>Mobile Number</label>
                    <input type='text' className='form-control p-2' name='mph' value={formData?.mph||''}
                        onChange={handleChange} required></input>
                </div>
                <div className='d-flex flex-column mt-3'>
                    <label className='form-label'>Address</label>
                    <input type='text' className='form-control p-2' name='address' value={formData?.address||''}
                        onChange={handleChange} required></input>
                </div>
