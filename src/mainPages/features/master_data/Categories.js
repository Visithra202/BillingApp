    ...
    <div className='bg-white m-4 mt-4  border rounded-5 shadow'>
      ...
      <form onSubmit={handleSubmit} className='p-3 px-5'>
        <div className='d-flex flex-column'>
          ...
          <input type='text' className='form-control p-2' name='category_name' value={formData.category_name}
            onChange={handleChange} autoComplete="off" required></input>
        </div>
        <div className='d-flex flex-column mt-3'>
          <label className='form-label'>Description</label>
          <input type='text' className='form-control p-2' name='description' value={formData.description}
            onChange={handleChange} autoComplete='off' required></input>
        </div>
