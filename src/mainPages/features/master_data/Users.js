    ...
    <div className='bg-white m-4 mt-4 border rounded-5 shadow'>
      ...
      <form onSubmit={handleSubmit} className='py-3 px-4'>
        <div className='d-flex flex-column'>
          ...
          <input type='text' className='form-control p-2' name='username' value={userFormData.username}
            onChange={handleChange} autoComplete="off" required></input>
        </div>
        <div className='d-flex flex-column mt-3'>
          <label className='form-label'>Password</label>
          <input type='password' className='form-control p-2' name='password' value={userFormData.password}
            onChange={handleChange} autoComplete='off' required></input>
        </div>
        <div className='d-flex flex-column mt-3'>
          <label className='form-label'>Confirm password</label>
          <input type='password' className='form-control p-2' name='confirm_password' value={userFormData.confirm_password}
            onChange={handleChange} autoComplete='off' required></input>
        </div>
