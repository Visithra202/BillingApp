    ...
    <div className='container'>
      <div className='row bg-light mt-1 mb-0 mx-0 p-2 border rounded shadow d-flex'>
        ...
        <div className='col d-flex flex-column'>
          ...
          <input className='form-control border rounded-pill px-2' disabled value={date.toLocaleDateString()} style={{ width: '200px' }} />
        </div>

        {/* Bill No */}
        <div className='col d-flex flex-column'>
          <label className='form-label'>Bill No</label>
          <input className='form-control border rounded-pill px-2' disabled value={billNo} style={{ width: '200px' }} />
        </div>
      </div>
      ...
      <div className='position-fixed bottom-0 d-flex flex-column justify-content-center align-items-center bg-light pt-2 pb-1 border rounded shadow'
        ...
        <div className='d-flex justify-content-between w-100 mx-5 px-4 '>
          ...
          <div className='d-flex'>
            <label className='form-label d-flex align-items-end'>Total Amount</label>
            <input className='payment border rounded ps-2 ms-2' style={{ width: '150px' }} value={totalAmount.toFixed(2)} disabled />
          </div>
        </div>
...
function PaymentMode({ cash, setCash, credit, setCredit, account, setAccount }) {
  ...
  return (
    <>
      ...
      <div>
        <label className='form-label ms-2'>Account</label>
        <input
      ...
      <div>
        <label className='form-label ms-2'>Credit</label>
        <input
...
function CustomerSelection({ activeDropdown, setActiveDropdown, searchCustomer, setSearchCustomer, setSelectedCustomer }) {
  ...
  return (
    <>
      ...
      <input className='form-control border rounded-pill px-2' placeholder='Search Customer'
