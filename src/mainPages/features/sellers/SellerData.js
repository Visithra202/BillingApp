...
function SellerForm({ setReload }) {
    ...
    return (
        <div className='bg-white m-4  border rounded-5 shadow'>
            ...
            <form onSubmit={handleSubmit} className='p-3 px-5' autoComplete='off'>
                <div className='d-flex flex-column'>
                    <label className='form-label'>Seller name</label>
                    <input type='text' className='form-control p-2' name='seller_name' value={sellerFormData?.seller_name||''}
                        onChange={handleChange}  required></input>
                </div>
                <div className='d-flex flex-column mt-3'>
                    <label className='form-label'>Mobile Number</label>
                    <input type='text' className='form-control p-2' name='seller_mph' value={sellerFormData?.seller_mph||''}
                        onChange={handleChange} required></input>
                </div>
                <div className='d-flex flex-column mt-3'>
                    <label className='form-label'>Address</label>
                    <input type='text' className='form-control p-2' name='address' value={sellerFormData?.address||''}
                        onChange={handleChange} required></input>
                </div>
